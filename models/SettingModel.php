...
class SettingModel extends ActiveRecord
{
    ...
    {
        if ($insert) {
            $this->schoolId = \Yii::$app->school->id;
        }
    ...
    public function rules(): array
    {
        return [
            ...
            [['section', 'key', 'schoolId'], 'unique', 'targetAttribute' => ['schoolId', 'section', 'key']],
            [['value', 'type'], 'string'],
    ...
    {
        $model = static::findOne(['section' => $section, 'key' => $key, 'schoolId' => \Yii::$app->school->id]);
